...
(function (root, factory) {
    ...
    renderYearsList = function(date, opts)
    {
        var d = moment(date),
            ...
            maxYear = years && years.max ? years.max : Number(moment().format('YYYY'));

        if (Number(date.format('YYYY')) < minYear) {
            minYear = Number(date.format('YYYY'));
        }

        if (Number(date.format('YYYY')) > maxYear) {
            maxYear = Number(date.format('YYYY'));
        }
    ...
    Lightpick.prototype = {
        ...
        reloadOptions: function(options)
        {
            ...
            $.extend(this._opts, this._opts, options);
            $.extend(this._opts.dropdowns, dropdowns, options.dropdowns);
            $.extend(this._opts.locale, locale, options.locale);
        }
